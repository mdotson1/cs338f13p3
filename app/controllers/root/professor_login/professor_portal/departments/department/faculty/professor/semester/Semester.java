package controllers.root.professor_login.professor_portal.departments.department.faculty.professor.semester;
...
import views.html.root.professor_login.professor_portal.departments.department.faculty.professor.semester.*;
...
public class Semester extends Controller {
                             ...
                             final int professorId, final String seasonAndYear)
    {
        return controllers.root.professor_login.professor_portal.departments.
                department.faculty.professor.semester.routes.Semester.get(
                thisId, department, professorId, seasonAndYear).url();
    }
